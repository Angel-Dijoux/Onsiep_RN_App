...
const FavScreen = ({navigation}) => {
    ...
    const {GetFavoris,favisloading, favoris } = useContext(AuthContext)

    const netInfo = useNetInfo()
    const header = () => {
        return <Text style={{marginLeft:"6%", marginTop: 17, fontWeight: "900", fontSize: 20}}>Favoris, {String(netInfo.isConnected)}</Text>
